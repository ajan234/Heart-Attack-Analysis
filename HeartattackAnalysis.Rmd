...
```{r, echo = FALSE}
heart <- read.csv("C:/Users/Ajanthan/Desktop/Self Projects/Heartattack Data Set/heart.csv")
head(heart, 5)
```
...
```
The AUC on testing set is 0.943 which is approximetly 94%. This is an indication that the model prediction performance is good. 
